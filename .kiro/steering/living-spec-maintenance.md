...
The Living Spec at `.kiro/specs/00-mealprep.living.md` is the **single source of truth** for this project.
...
└── 00-mealprep.living.md (🔵 Planning)
```

## Current Strategy

**Problem**: Busy professionals spend too much time planning meals and building grocery lists each week.
